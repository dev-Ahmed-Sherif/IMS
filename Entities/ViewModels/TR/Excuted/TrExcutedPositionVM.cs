...
namespace Entities.ViewModels.TR.Excuted
{
    ...
    public class TrExcutedPositionGeneralVM
    {
    ...
    public class TrExcutedPositionVM : TrExcutedPositionGeneralVM
    {
        public int Id { get; set; }
    }
    public class TrExcutedPositionGetVM : TrExcutedPositionVM
    {
