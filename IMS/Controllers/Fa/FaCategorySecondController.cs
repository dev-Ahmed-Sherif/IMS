...
namespace IMS.Controllers.Fa
{
    ...
    [ApiController]
    public class FaCategorySecondController : ControllerBase
    {

        private FaCategorySecondService _fa_cat;

        public FaCategorySecondController(FaCategorySecondService AddService)
        {
            _fa_cat = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] FaCategorySecondGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] FaCategorySecondVM update)
        {
