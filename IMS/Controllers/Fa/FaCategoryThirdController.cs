...
namespace IMS.Controllers.Fa
{
    ...
    [ApiController]
    public class FaCategoryThirdController : ControllerBase
    {
        private FaCategoryThirdService _fa_cat;

        public FaCategoryThirdController(FaCategoryThirdService AddService)
        {
            _fa_cat = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] FaCategoryThirdGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] FaCategoryThirdVM update)
        {
