...
namespace IMS.Controllers.Pro
{
    ...
    [ApiController]
    public class ProPlanTypeController : ControllerBase
    {
        private ProPlanTypeService _pro;

        public ProPlanTypeController(ProPlanTypeService AddService)
        {
            _pro = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] ProPlantTypeGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] ProPlanTypeVM update)
        {
