...
namespace IMS.Controllers.Pro
{
    ...
    public class ProTenderVendorReqSendTypeController : ControllerBase
    {
        ...
        {
            ProTenderVendorReqSendType model = _ProTenderVendorReqSendTypeService.GetById(id);
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, ProTenderVendorReqSendTypeGeneralVM input)
        {
