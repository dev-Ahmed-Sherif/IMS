...
namespace IMS.Controllers.TR.General
{
    ...
    public class TrClassRoomController : ControllerBase
    {
        private TrClassRoomService _Service;

        public TrClassRoomController(TrClassRoomService TrClassRoomService)
        {
            _Service = TrClassRoomService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrClassRoomVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrClassRoomVM update)
        {
