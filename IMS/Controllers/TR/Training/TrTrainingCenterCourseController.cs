...
namespace IMS.Controllers.TR.Training
{
    ...
    [ApiController]
    public class TrTrainingCenterCourseController : ControllerBase
    {
        private TrTrainingCenterCourseService _Service;

        public TrTrainingCenterCourseController(TrTrainingCenterCourseService TrTrainingCenterCourseService)
        {
            _Service = TrTrainingCenterCourseService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrTrainingCenterCourseVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrTrainingCenterCourseVM update)
        {
