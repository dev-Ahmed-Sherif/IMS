...
namespace IMS.Controllers.TR.Training
{
    ...
    [ApiController]
    public class TrTrainingCenterController : ControllerBase
    {
        private TrTrainingCenterService _Service;

        public TrTrainingCenterController(TrTrainingCenterService TrainingCenterService)
        {
            _Service = TrainingCenterService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrTrainingCenterVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrTrainingCenterVM update)
        {
