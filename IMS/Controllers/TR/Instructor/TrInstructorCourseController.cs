...
namespace IMS.Controllers.TR.Instructor
{
    [Route("api/[controller]")]
    [ApiController]
    public class TrInstructorCourseController : ControllerBase
    {
        private TrInstructorCourseService _Service;

        public TrInstructorCourseController(TrInstructorCourseService AddService)
        {
            _Service = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrInstructorCourseGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrInstructorCourseVM update)
        {
