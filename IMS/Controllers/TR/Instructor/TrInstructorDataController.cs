...
namespace IMS.Controllers.TR.Instructor
{
    ...
    [ApiController]
    public class TrInstructorDataController : ControllerBase
    {
        private TrInstructorDataService _Service;

        public TrInstructorDataController(TrInstructorDataService AddService)
        {
            _Service = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrInstructorDataGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrInstructorDataVM update)
        {
