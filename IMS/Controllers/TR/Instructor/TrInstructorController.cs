...
namespace IMS.Controllers.TR.Instructor
{
    ...
    [ApiController]
    public class TrInstructorController : ControllerBase
    {

        private TrInstructorService _Service;

        public TrInstructorController(TrInstructorService AddService)
        {
            _Service = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrInstructorGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrInstructorVM update)
        {
