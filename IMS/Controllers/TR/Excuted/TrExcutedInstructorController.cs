...
namespace IMS.Controllers.TR.Excuted
{
    ...
    [ApiController]
    public class TrExcutedInstructorController : ControllerBase
    {
        private TrExcutedInstructorService _sTR_AddService;

        public TrExcutedInstructorController(TrExcutedInstructorService AddService)
        {
            _sTR_AddService = AddService;
        }

        [HttpPost("Add")]
        public IActionResult Add([FromBody] TrExcutedInstructorGeneralVM add)
        {
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] TrExcutedInstructorVM update)
        {
